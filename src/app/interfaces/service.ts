 ...
 * Dữ liệu được ánh xạ từ file services.json
 */
...
/**
 * Interface cho từng dịch vụ chi tiết.
 * Dùng cho cả expertServices và extraServices từ services.json
 */
...
/**
 * Cấu trúc dữ liệu từ services.json
 */
