...
export class CustomerStarComponent implements OnInit {
  ...
  benefits = [
    {
      icon: '../../assets/images/ic_bronze_badge.png',
    ...
    {
      icon: '../../assets/images/ic_silver_badge.png',
    ...
    {
      icon: '../../assets/images/ic_gold_badge.png',
    ...
    {
      icon: '../../assets/images/ic_platinum_badge.png',
    ...
    {
      icon: '../../assets/images/ic_diamond_badge.png',
