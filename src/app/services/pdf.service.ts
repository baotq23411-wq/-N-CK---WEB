...
export class PdfService {
  ...
  private loadArialUnicodeFont(doc: jsPDF): void {
    ...
    try {
      // TODO: Thay thế FONT_BASE64_PLACEHOLDER bằng Base64 string của Arial Unicode MS
      // Xem hướng dẫn trong file FONT_SETUP.md
